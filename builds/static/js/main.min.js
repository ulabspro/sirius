...
g=(b.options.rtl===!1?1:-1)*(b.touchObject.curX>b.touchObject.startX?1:-1),b.options.verticalSwiping===!0&&(g=b.touchObject.curY>b.touchObject.startY?1:-1),f=b.touchObject.swipeLength,b.touchObject.edgeHit=!1,b.options.infinite===!1&&(0===b.currentSlide&&"right"===e||b.currentSlide>=b.getDotCount()&&"left"===e)&&(f=b.touchObject.swipeLength*b.options.edgeFriction,b.touchObject.edgeHit=!0),b.options.vertical===!1?b.swipeLeft=d+f*g:b.swipeLeft=d+f*(b.$list.height()/b.listWidth)*g,b.options.verticalSwiping===!0&&(b.swipeLeft=d+f*g),b.options.fade!==!0&&b.options.touchMove!==!1&&(b.animating===!0?(b.swipeLeft=null,!1):void b.setCSS(b.swipeLeft))):void 0)},b.prototype.swipeStart=function(a){var c,b=this;return b.interrupted=!0,1!==b.touchObject.fingerCount||b.slideCount<=b.options.slidesToShow?(b.touchObject={},!1):(void 0!==a.originalEvent&&void 0!==a.originalEvent.touches&&(c=a.originalEvent.touches[0]),b.touchObject.startX=b.touchObject.curX=void 0!==c?c.pageX:a.clientX,b.touchObject.startY=b.touchObject.curY=void 0!==c?c.pageY:a.clientY,void(b.dragging=!0))},b.prototype.unfilterSlides=b.prototype.slickUnfilter=function(){var a=this;null!==a.$slidesCache&&(a.unload(),a.$slideTrack.children(this.options.slide).detach(),a.$slidesCache.appendTo(a.$slideTrack),a.reinit())},b.prototype.unload=function(){var b=this;a(".slick-cloned",b.$slider).remove(),b.$dots&&b.$dots.remove(),b.$prevArrow&&b.htmlExpr.test(b.options.prevArrow)&&b.$prevArrow.remove(),b.$nextArrow&&b.htmlExpr.test(b.options.nextArrow)&&b.$nextArrow.remove(),b.$slides.removeClass("slick-slide slick-active slick-visible slick-current").attr("aria-hidden","true").css("width","")},b.prototype.unslick=function(a){var b=this;b.$slider.trigger("unslick",[b,a]),b.destroy()},b.prototype.updateArrows=function(){var b,a=this;b=Math.floor(a.options.slidesToShow/2),a.options.arrows===!0&&a.slideCount>a.options.slidesToShow&&!a.options.infinite&&(a.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false"),a.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false"),0===a.currentSlide?(a.$prevArrow.addClass("slick-disabled").attr("aria-disabled","true"),a.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false")):a.currentSlide>=a.slideCount-a.options.slidesToShow&&a.options.centerMode===!1?(a.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),a.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")):a.currentSlide>=a.slideCount-1&&a.options.centerMode===!0&&(a.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),a.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")))},b.prototype.updateDots=function(){var a=this;null!==a.$dots&&(a.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),a.$dots.find("li").eq(Math.floor(a.currentSlide/a.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},b.prototype.visibility=function(){var a=this;a.options.autoplay&&(document[a.hidden]?a.interrupted=!0:a.interrupted=!1)},a.fn.slick=function(){var f,g,a=this,c=arguments[0],d=Array.prototype.slice.call(arguments,1),e=a.length;for(f=0;e>f;f++)if("object"==typeof c||"undefined"==typeof c?a[f].slick=new b(a[f],c):g=a[f].slick[c].apply(a[f].slick,d),"undefined"!=typeof g)return g;return a}}),$(".certificates-slider").slick({infinite:!0,slidesToShow:4,arrows:!0,slidesToScroll:1,prevArrow:$(".certificates-slider-controls__item._prev"),nextArrow:$(".certificates-slider-controls__item._next")}),google.maps.event.addDomListener(window,"load",initContactsMap),$(function(){$('[data-action="rotate"]').each(function(){function animation(){var x=center.X*Math.sin(start),y=center.Y*Math.cos(start),X=x*Math.cos(angle)-y*Math.sin(angle),Y=x*Math.sin(angle)+y*Math.cos(angle);$planet.css({top:center.Y+Y,left:center.X+X}),start+=.02,process=setTimeout(animation,interval)}var process,$item=$(this),$planet=$item.children(".cosmos-ellipse-planet"),dims={W:$item.data("width"),H:$item.data("height")},center={X:dims.W/2,Y:dims.H/2},rotate=(dims.W/dims.H,$item.data("rotate")),angle=0,start=$item.data("start"),time=$item.data("time"),interval=time,translate=$item.data("translate");$item.css({transform:"translate("+translate+")"}),$(".cosmos-ellipse").on("mouseenter",function(){clearTimeout(process)}).on("mouseleave",function(){animation()}),$(".cosmos-ellipse-planet").on("mouseenter",function(){var offsetLeft=parseInt($(this).css("left"));offsetLeft>300?($(this).find(".cosmos-ellipse-planet-popup").css({"z-index":"999999",display:"block",left:"-375px"}),$(".cosmos-ellipse-circle").css("z-index","-10000"),$(this).parent(".cosmos-ellipse-circle").css("z-index","1000")):offsetLeft<1e3&&($(this).find(".cosmos-ellipse-planet-popup").css({"z-index":"999999",display:"block",right:"-375px"}),$(".cosmos-ellipse-circle").css("z-index","-10000"),$(this).parent(".cosmos-ellipse-circle").css("z-index","1000"))}).on("mouseleave",function(){offsetLeft=0,$(this).find(".cosmos-ellipse-planet-popup").css({"z-index":"0",display:"none",left:"initial",right:"initial"})}),rotate&&(rotate=rotate.split("*"),void 0!==rotate[1]?angle=Math.PI*parseInt(rotate[0])/180:$item.css({transform:"rotateZ("+rotate[0]+")"})),animation()})});var infowindow=null,gmarkers=[],defaultIcon={url:"../static/images/general/map-pic.png",size:new google.maps.Size(58,71),origin:new google.maps.Point(0,0),scaledSize:new google.maps.Size(58,71)},activeIcon={url:"../static/images/general/map-pic-active.png",size:new google.maps.Size(58,71),origin:new google.maps.Point(0,0),scaledSize:new google.maps.Size(58,71)},shape={coord:[9,0,6,1,4,2,2,4,0,8,0,12,1,14,2,16,5,19,7,23,8,26,9,30,9,34,11,34,11,30,12,26,13,24,14,21,16,18,18,16,20,12,20,8,18,4,16,2,15,1,13,0],type:"poly"};$(document).ready(function(){initialize()});var sites=[["Магнит",55.75541546,37.60704323,1,"._first"],["Пятерочка",55.75971385,37.62738511,2,"._second"]];$(".product-full-slider").slick({infinite:!0,slidesToShow:1,arrows:!0,slidesToScroll:1,prevArrow:$(".product-fill-slider-controls__item._prev"),nextArrow:$(".product-full-slider-controls__item._next")}),$(".js-hide-trigger").click(function(e){e.preventDefault(),$(this).parent(".js-hide").find(".js-hide-element").slideToggle(),$(this).toggleClass("_hide")}),$(".product-list-slider").slick({infinite:!0,slidesToShow:1,arrows:!0,slidesToScroll:1,prevArrow:$(".product-list-slider-controls__item._prev"),nextArrow:$(".product-list-slider-controls__item._next")}),$(".subcatalog-list-slider").slick({infinite:!0,slidesToShow:1,arrows:!0,slidesToScroll:1,prevArrow:'<div class="subcatalog-list-slider-controls__item _prev">Назад</div>',nextArrow:'<div class="subcatalog-list-slider-controls__item _next">Далее</div>',appendArrows:$(".subcatalog-list-slider-controls")});